<template>
    <div class="flex flex-wrap justify-center mx-6">
        ...
        <div class="w-full md:w-1/2 bg-white p-4">
            <h2 class="text-xl font-bold mb-6">Create a Post</h2>

            <!-- Post Type Selector -->
            <div class="flex space-x-4 mb-6">
                <button :class="{ 'bg-blue-500 text-white': postType === 'text' }" @click="setPostType('text')"
                    class="px-4 py-2 rounded-md bg-gray-200 text-gray-700 hover:bg-gray-300">
                    Post Text
                </button>
                <button :class="{ 'bg-blue-500 text-white': postType === 'image' }" @click="setPostType('image')"
                    class="px-4 py-2 rounded-md bg-gray-200 text-gray-700 hover:bg-gray-300">
                    Post Image
                </button>
                <button :class="{ 'bg-blue-500 text-white': postType === 'link' }" @click="setPostType('link')"
                    class="px-4 py-2 rounded-md bg-gray-200 text-gray-700 hover:bg-gray-300">
                    Post Link
                </button>
            </div>
            ...
            <div v-if="postType === 'text'">
                ...
                <input v-model="linkUrl" type="text" placeholder="Tittle"
                    class="w-full p-4 border rounded-lg focus:outline-none my-2" />
                    ...
                    <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 ">
                        ...
                        <div class="px-4 py-2 bg-white rounded-b-lg ">
                            ...
                            <textarea id="editor" rows="8"
                                class="block w-full px-0 text-sm text-gray-800 bg-white border-0focus:ring-0 "
            ...
            <div v-if="postType === 'image'">
                ...
                <div v-if="imageUrl" class="mt-4">
                    <img :src="imageUrl" alt="Preview" class="w-full h-auto rounded-md" />
                </div>
                ...
                <button @click="submitPost" class="mt-4 px-4 py-2 bg-blue-600 text-white rounded-md">
                    Post Image
                </button>
            </div>
            ...
            <div v-if="postType === 'link'">
                <input v-model="linkUrl" type="text" placeholder="Tittle"
                    class="w-full p-4 border rounded-lg focus:outline-none my-2" />
                <input v-model="linkUrl" type="text" placeholder="Enter link URL"
...
export default {
    ...
    methods: {
        ...
        submitPost() {
            // Handle post submission logic based on postType
            if (this.postType === 'text') {
                console.log('Posting text:', this.postContent)
            } else if (this.postType === 'image') {
                console.log('Posting image:', this.imageUrl)
            } else if (this.postType === 'link') {
                console.log('Posting link:', this.linkUrl)
            }
        }
    }
}
